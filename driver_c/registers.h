...
enum FlashChannelMap{
  FLASH_EQ_GAIN_TRIM = 0x01,
  FLASH_USER_EQ_GAIN_TRIM = 0x03,
  FLSAH_EQ_FILTER_GAIN = 0x06,
  FLASH_EQ_FILTER_A2 = 0x07,//-A2
  FLASH_EQ_FILTER_A3 = 0x09, // -A3
  FLASH_EQ_FILTER_B3 = 0x0A, // B3 and rectify bit
  FLASH_EQ_FILTER_B2 = 0x0B,
  
  FLASH_TRIM_GAIN_1 = 0x31,
  FLASH_TRIM_GAIN_2 = 0x33,
  FLASH_TRIM_GAIN_4 = 0x35,
  FLASH_EQ_TRIM_GAIN_2 = 0x37,
  FLASH_EQ_TRIM_GAIN_4 = 0x39,
  
  // for ADC gain 1,2,4
  FLASH_LP_FILTER_GAIN_S1 = 0x3A,
  FLASH_LP_FILTER_A2_S1 = 0x3B, //-A2
  FLASH_LP_FILTER_A3_S1 = 0x3D, // -A3
  FLASH_LP_FILTER_B3_S1 = 0x3E,
  FLASH_LP_FILTER_B2_S1 = 0x3F,

  FLASH_LP_FILTER_GAIN_S2 = 0x4C,
  FLASH_LP_FILTER_A2_S2 = 0x4D, //-A2
  FLASH_LP_FILTER_A3_S2 = 0x4F, // -A3
  FLASH_LP_FILTER_B3_S2 = 0x50,
  FLASH_LP_FILTER_B2_S2 = 0x51
};

enum FlashFilterStegesOffsets {
  FILTER_STAGE_1 = 0x00,
  FILTER_STAGE_2 = 0x06,
  FILTER_STAGE_3 = 0x0C,
  FILTER_STAGE_4 = 0x12,
